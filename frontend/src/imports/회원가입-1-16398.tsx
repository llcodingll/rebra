...
import { imgVector, imgVector1, imgSvg, imgSvg1, imgSvg2, imgSvg3, imgSvg4, imgSvg5, imgSvg6, imgSvg7, imgVector2, imgVector3, imgVector4, imgVector5, imgVector6 } from "./svg-c8u5w";
  ...
  return (
    <div className="content-stretch flex flex-col items-center justify-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[21px] text-center text-neutral-950 w-full">
        <p className="leading-[28px]">회원가입</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-center justify-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4a5565] text-[14px] text-center w-full">
        <p className="leading-[21px]">새 계정을 만들어 투자 여정을 시작하세요</p>
      </div>
    </div>
  );
}
...
function Tab() {
  return (
    <div className="box-border content-stretch flex h-[25.5px] items-center justify-center pb-[4.5px] pl-[67.63px] pr-[67.62px] pt-[3px] relative rounded-[12.75px] shrink-0" data-name="Tab">
...
function Tab1() {
  return (
    <div className="bg-white box-border content-stretch flex h-[25.5px] items-center justify-center pb-[4.5px] pt-[3px] px-[61.5px] relative rounded-[12.75px] shrink-0" data-name="Tab">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12.3px] text-center text-neutral-950 text-nowrap">
  ...
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Label">
      <div className="basis-0 flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12.3px] text-neutral-950">
        <p className="leading-[12.25px]">이름</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute bottom-[7.75px] box-border content-stretch flex flex-col items-start justify-start left-9 overflow-clip pb-0.5 pl-0 pr-[85.5px] pt-[3px] top-[6.75px]" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#717182] text-[12.3px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">홍길동</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return <div className="absolute bottom-[8.75px] left-9 top-[8.75px] w-[122.25px]" data-name="Container" />;
}
...
function Container24() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[6.75px] grow items-start justify-start min-h-px min-w-px relative self-stretch shrink-0" data-name="Container">
      <Label />
      <Container23 />
    </div>
  );
...
function Label1() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Label">
      <div className="basis-0 flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12.3px] text-neutral-950">
        <p className="leading-[12.25px]">전화번호</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute bottom-[8.75px] box-border content-stretch flex flex-col items-start justify-start left-9 overflow-clip pl-0 pr-[39.16px] py-px top-[8.75px]" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#717182] text-[12.3px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">010-1234-5678</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="content-stretch flex gap-[10.5px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Container24 />
      <Container28 />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute bottom-[8.75px] box-border content-stretch flex flex-col items-start justify-start left-9 overflow-clip pl-0 pr-[190.72px] py-px top-[8.75px]" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#717182] text-[12.3px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">hong@example.com</p>
      </div>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="absolute bottom-[7.75px] box-border content-stretch flex flex-col items-start justify-start left-9 overflow-clip pb-0.5 pl-0 pr-[166.37px] pt-[3px] top-[6.75px]" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#717182] text-[12.3px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">8자 이상 입력하세요</p>
      </div>
    </div>
  );
}
...
function Svg8() {
  return (
    <div className="relative shrink-0 size-3.5" data-name="SVG">
      <img className="block max-w-none size-full" src={imgSvg7} />
    </div>
  );
}
...
function Label4() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Label">
      <div className="basis-0 flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12.3px] text-neutral-950">
        <p className="leading-[12.25px]">비밀번호 확인</p>
      </div>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="absolute bottom-[7.75px] box-border content-stretch flex flex-col items-start justify-start left-9 min-w-[278px] overflow-clip pb-0.5 pl-0 pr-[124.19px] pt-[3px] top-[6.75px]" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#717182] text-[12.3px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">비밀번호를 다시 입력하세요</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#fb2c36] text-[12.3px] text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">*</p>
      </div>
    </div>
  );
}
...
function Label5() {
  return (
    <div className="content-stretch flex gap-[7px] items-center justify-start relative shrink-0" data-name="Label">
      <Container42 />
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12.3px] text-neutral-950 text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">이용약관에 동의합니다</p>
      </div>
    </div>
  );
}
...
function Label6() {
  return (
    <div className="content-stretch flex gap-[7px] items-center justify-start relative shrink-0" data-name="Label">
      <Container44 />
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12.3px] text-neutral-950 text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">개인정보처리방침에 동의합니다</p>
      </div>
    </div>
  );
}
...
function Container46() {
  return (
    <div className="box-border content-stretch flex items-center justify-start pb-0 pt-[0.75px] px-0 relative shrink-0 w-full" data-name="Container">
      <CheckboxMargin2 />
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12.3px] text-neutral-950 text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">마케팅 정보 수신에 동의합니다 (선택)</p>
      </div>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[9.5px] items-start justify-start pb-0 pt-1.5 px-0 relative shrink-0 w-full" data-name="Container">
      <Container43 />
      <Container45 />
      <Container46 />
    </div>
...
function Button3() {
  return (
    <div className="bg-gradient-to-r from-[#155dfc] h-[31.5px] opacity-50 relative rounded-[6.75px] shrink-0 to-[#9810fa] w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex h-[31.5px] items-center justify-center pb-[7.5px] pt-1.5 px-3.5 relative w-full">
          <div className="basis-0 flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[12.3px] text-center text-white">
            <p className="leading-[17.5px]">계정 만들기</p>
          </div>
        </div>
      </div>
    </div>
...
function Background1() {
  return (
    <div className="bg-white relative self-stretch shrink-0 w-[52.5px]" data-name="Background">
      <div className="absolute flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] h-[18px] justify-center leading-[0] left-3.5 not-italic text-[#6a7282] text-[12.3px] top-2 translate-y-[-50%] w-[24.7px]">
        <p className="leading-[17.5px]">또는</p>
      </div>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start relative shrink-0 w-full z-[2]" data-name="Container">
      <Container49 />
      <Container50 />
    </div>
  );
...
function SvgMargin1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-3.5 items-start justify-start left-[51.14px] pl-0 pr-[7px] py-0 top-[8.75px] w-[21px]" data-name="SVG:margin">
      <Svg11 />
    </div>
  );
}
...
function Button4() {
  return (
    <div className="basis-0 bg-white grow h-[31.5px] min-h-px min-w-px relative rounded-[6.75px] shrink-0" data-name="Button">
      ...
      <SvgMargin1 />
      <div className="absolute flex flex-col font-['Segoe_UI_Symbol:Regular',_sans-serif] h-[18px] justify-center leading-[0] not-italic text-[12.3px] text-center text-neutral-950 translate-x-[-50%] translate-y-[-50%] w-[39.67px]" style={{ top: "calc(50% - 0.75px)", left: "calc(50% + 14.1px)" }}>
        <p className="leading-[17.5px]">Google</p>
      </div>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-3.5" data-name="Frame">
      <div className="absolute bottom-[-0.04%] left-[0.05%] right-[-0.03%] top-0" data-name="Vector">
...
function SvgMargin2() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-3.5 items-start justify-start left-[53.59px] pl-0 pr-[7px] py-0 top-[8.75px] w-[21px]" data-name="SVG:margin">
      <Svg12 />
    </div>
  );
}
...
function Button5() {
  return (
    <div className="basis-0 bg-white grow h-[31.5px] min-h-px min-w-px relative rounded-[6.75px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[6.75px]" />
      <SvgMargin2 />
      <div className="absolute flex flex-col font-['Segoe_UI_Symbol:Regular',_sans-serif] h-[18px] justify-center leading-[0] not-italic text-[12.3px] text-center text-neutral-950 translate-x-[-50%] translate-y-[-50%] w-[34.76px]" style={{ top: "calc(50% - 0.75px)", left: "calc(50% + 14.095px)" }}>
        <p className="leading-[17.5px]">Kakao</p>
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="content-stretch flex gap-[10.5px] items-start justify-center relative shrink-0 w-full z-[1]" data-name="Container">
      <Button4 />
      <Button5 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex items-start justify-start relative size-full" data-name="회원가입">
      <Background />
      <Container57 />
    </div>
  );
