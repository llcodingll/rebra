...
import { imgSvg, imgSvg1, imgVector, imgVector1, imgVector2, imgVector3, imgVector4, imgVector5, imgVector6, imgVector7, imgVector8, imgVector9, imgVector10, imgGroup, imgGroup1, imgGroup2, imgGroup3, imgGroup4, imgFrame, imgVector11, imgVector12, imgBg } from "./svg-xz0xw";
...
function Header() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col items-start justify-start left-0 pb-[15px] pt-3.5 px-[21px] top-0 w-[1725px]" data-name="Header">
...
function Nav() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col items-start justify-start left-0 pb-px pt-0 px-[21px] top-[57px] w-[1725px]" data-name="Nav">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none" />
      <Container11 />
    </div>
  );
...
function BackgroundHorizontalBorder() {
  return (
    <div className="absolute bg-gray-50 box-border content-stretch flex flex-col items-start justify-start left-0 pb-[11.5px] pt-[10.5px] px-[21px] top-[89.5px] w-[1725px]" data-name="Background+HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none" />
      <Container25 />
    </div>
  );
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start min-w-[72.582px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18.019px] text-neutral-950 text-nowrap">
...
function Frame7() {
  return (
    <div className="absolute h-[66.288px] left-[30.94px] overflow-clip top-[18.39px] w-[233.012px]">
      ...
      <div className="absolute font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[0] left-[142.69px] not-italic text-[#4a5565] text-[19.083px] text-center text-nowrap top-[10.74px] translate-x-[-50%]">
...
function Frame16() {
  return (
    <div className="absolute h-[84.04px] left-[63.24px] overflow-clip top-[433.6px] w-[403.858px]">
      ...
      <div className="absolute font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[0] left-[46.88px] not-italic text-[#4a5565] text-[10.977px] text-center text-nowrap top-[27.12px] translate-x-[-50%]">
      ...
      <div className="absolute font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[0] left-[206.55px] not-italic text-[#4a5565] text-[10.977px] text-center text-nowrap top-[27.12px] translate-x-[-50%]">
...
function Main() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[1988px] items-start justify-start left-[17px] top-[180px] w-[1691px]" data-name="Main">
      <Container155 />
    </div>
  );
}
...
function Group28() {
  return (
    <div className="absolute contents inset-[92.38%_17.63%_3.18%_73%]">
      <div className="absolute bg-white inset-[92.38%_17.63%_3.18%_73%] rounded-[6.75px]" data-name="Rectangle">
      ...
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[93.39%_20.63%_4.32%_76.13%] leading-[0] not-italic text-[14px] text-center text-neutral-950 text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">취소</p>
      </div>
    </div>
  );
}
...
function Group27() {
  return (
    <div className="absolute contents inset-[92.38%_3.13%_3.18%_84%]">
      <div className="absolute bg-[#e9e9e9] inset-[92.38%_3.13%_3.18%_84%] rounded-[6.75px]" data-name="Rectangle" />
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[93.39%_6%_4.32%_87%] leading-[0] not-italic text-[#999999] text-[14px] text-center text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">선택 완료</p>
      </div>
    </div>
  );
}
...
function Component2() {
  return (
    <div className="absolute inset-[74.46%_5%_12.2%_3.13%]" data-name="포트폴리오 개별">
      <div className="absolute bg-white inset-0 rounded-[8px]" data-name="Rectangle">
        <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[15.24%_62.59%_67.62%_9.52%] leading-[0] not-italic text-[14px] text-neutral-950 text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">삼성전자 + SK하이닉스 포트폴리오</p>
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_sans-serif] inset-[15.24%_55.51%_67.62%_38.91%] leading-[0] not-italic text-[12px] text-[red] text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">+24.5%</p>
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[44.76%_84.63%_38.09%_9.52%] leading-[0] not-italic text-[#4a5565] text-[12px] text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">3개 종목</p>
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[69.52%_77.82%_17.14%_9.52%] leading-[0] not-italic text-[#4a5565] text-[11px] text-nowrap">
        <p className="leading-[14px] whitespace-pre">생성일: 2024-01-15</p>
      </div>
      <div className="absolute inset-[18.09%_2.58%_62.86%_94.69%] rounded-[2.68435e+07px]" data-name="Rectangle">
        <div aria-hidden="true" className="absolute border-2 border-[#e9e9e9] border-solid inset-0 pointer-events-none rounded-[2.68435e+07px]" />
      </div>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="absolute inset-[60.23%_5%_26.43%_3.13%]" data-name="포트폴리오 개별">
      <div className="absolute bg-white inset-0 rounded-[8px]" data-name="Rectangle">
        <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[15.24%_62.59%_67.62%_9.52%] leading-[0] not-italic text-[14px] text-neutral-950 text-nowrap">
...
function Component4() {
  return (
    <div className="absolute inset-[45.36%_5%_41.3%_3.13%]" data-name="포트폴리오 개별">
      <div className="absolute bg-white inset-0 rounded-[8px]" data-name="Rectangle">
        <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[15.24%_62.59%_67.62%_9.52%] leading-[0] not-italic text-[14px] text-neutral-950 text-nowrap">
...
function Component5() {
  return (
    <div className="absolute inset-[30.5%_5%_56.16%_3.13%]" data-name="포트폴리오 개별">
      <div className="absolute bg-white inset-0 rounded-[8px]" data-name="Rectangle">
        <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[15.24%_62.59%_67.62%_9.52%] leading-[0] not-italic text-[14px] text-neutral-950 text-nowrap">
...
function Component6() {
  return (
    <div className="absolute inset-[15.63%_5%_71.03%_3.13%]" data-name="포트폴리오 개별">
      <div className="absolute bg-white inset-0 rounded-[8px]" data-name="Rectangle">
        <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[8px]" />
      </div>
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[15.24%_62.59%_67.62%_9.52%] leading-[0] not-italic text-[14px] text-neutral-950 text-nowrap">
...
function Component7() {
  return (
    <div className="absolute h-[787px] left-[446px] top-[634px] w-[800px]" data-name="포폴 선택 모달">
      ...
      <div className="absolute inset-[0.13%_0.13%_87.42%_0.13%]" data-name="Rectangle">
      ...
      <div className="absolute font-['Segoe_UI_Symbol:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[2.92%_80%_94.03%_3.13%] leading-[0] not-italic text-[20px] text-neutral-950 text-nowrap">
        <p className="leading-[24px] whitespace-pre">포트폴리오 선택</p>
      </div>
      <div className="absolute font-['ABeeZee:Regular',_'Noto_Sans_KR:Regular',_sans-serif] inset-[7.12%_77%_90.6%_3.13%] leading-[0] not-italic text-[#4a5565] text-[14px] text-nowrap">
        <p className="leading-[17.5px] whitespace-pre">포트폴리오를 선택해주세요</p>
      </div>
      <div className="absolute inset-[89.2%_0.13%_0.13%_0.13%]" data-name="Rectangle">
...
export default function Component8() {
  return (
    <div className="bg-white relative size-full" data-name="대시보드-자산 현황">
      <Header />
      <Nav />
      <BackgroundHorizontalBorder />
      <Main />
      <div className="absolute h-[2331px] left-[-8px] top-[-10px] w-[1744px]" data-name="BG">
        <img className="block max-w-none size-full" src={imgBg} />
      </div>
      <Component7 />
    </div>
  );
