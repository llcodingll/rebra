          ...
          <div className={styles.heroContainer}>
            ...
            <div className={styles.heroImage}>
              <div className={styles.phoneContainer}>
                ...
                <div className={styles.phoneFrame}>{/* Phone mockup content */}</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className={styles.featuresGrid}>
              <div className={styles.featureCard}>
                <div className={styles.featureIcon}>
                  <svg width='21' height='21' viewBox='0 0 21 21' fill='none'>
                    ...
                    />
                    <path
                      d='M10.5 15.75C13.3995 15.75 15.75 13.3995 15.75 10.5C15.75 7.60051 13.3995 5.25 10.5 5.25C7.60051 5.25 5.25 7.60051 5.25 10.5C5.25 13.3995 7.60051 15.75 10.5 15.75Z'
                      stroke='white'
                      strokeWidth='1.75'
                      strokeLinecap='round'
                      strokeLinejoin='round'
              ...
              <div className={styles.featureCard}>
                <div className={styles.featureIcon}>
                  <svg width='21' height='21' viewBox='0 0 21 21' fill='none'>
                    <path
                      d='M2.625 2.625V16.625C2.625 17.0891 2.80937 17.5342 3.13756 17.8624C3.46575 18.1906 3.91087 18.375 4.375 18.375H18.375'
                      stroke='white'
                      strokeWidth='1.75'
                      strokeLinecap='round'
                      strokeLinejoin='round'
            ...
            <div className={styles.stepsGrid}>
              ...
              <div className={styles.step}>
                ...
                <div className={styles.stepIcon}>
                  <svg width='28' height='28' viewBox='0 0 28 28' fill='none'>
                    <path
                      d='M3.5 3.5V22.1667C3.5 22.7855 3.74583 23.379 4.18342 23.8166C4.621 24.2542 5.2145 24.5 5.83333 24.5H24.5'
                      stroke='white'
                      strokeWidth='2.33333'
                      strokeLinecap='round'
                      strokeLinejoin='round'
              ...
              <div className={styles.step}>
                ...
                <div className={styles.stepIcon}>
                  <svg width='28' height='28' viewBox='0 0 28 28' fill='none'>
                    <path
                      d='M4.66667 16.3333C4.44589 16.3341 4.22944 16.2722 4.04245 16.1548C3.85546 16.0374 3.70561 15.8694 3.61031 15.6703C3.51501 15.4711 3.47818 15.249 3.50408 15.0298C3.52999 14.8105 3.61758 14.6031 3.75667 14.4317L15.3067 2.53167C15.3933 2.43166 15.5114 2.36408 15.6415 2.34002C15.7716 2.31596 15.906 2.33685 16.0227 2.39926C16.1394 2.46166 16.2313 2.56188 16.2836 2.68346C16.3358 2.80504 16.3451 2.94076 16.31 3.06833L14.07 10.0917C14.0039 10.2684 13.9818 10.4586 14.0054 10.6458C14.0289 10.8331 14.0976 11.0118 14.2054 11.1667C14.3133 11.3215 14.4571 11.4479 14.6245 11.535C14.7919 11.6221 14.978 11.6673 15.1667 11.6667H23.3333C23.5541 11.6659 23.7706 11.7278 23.9576 11.8452C24.1445 11.9626 24.2944 12.1306 24.3897 12.3297C24.485 12.5289 24.5218 12.751 24.4959 12.9702C24.47 13.1895 24.3824 13.3969 24.2433 13.5683L12.6933 25.4683C12.6067 25.5683 12.4886 25.6359 12.3585 25.66C12.2284 25.684 12.094 25.6632 11.9773 25.6007C11.8606 25.5383 11.7687 25.4381 11.7164 25.3165C11.6642 25.195 11.6549 25.0592 11.69 24.9317L13.93 17.9083C13.9961 17.7316 14.0182 17.5414 13.9946 17.3542C13.9711 17.1669 13.9024 16.9882 13.7946 16.8333C13.6867 16.6785 13.5429 16.5521 13.3755 16.465C13.2081 16.3779 13.022 16.3327 12.8333 16.3333H4.66667Z'
                      stroke='white'
                      strokeWidth='2.33333'
                      strokeLinecap='round'
                      strokeLinejoin='round'
          ...
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.pricingGrid}>
              ...
              <div className={`${styles.pricingCard} ${styles.featured}`}>
                ...
                <button className={styles.pricingButtonPrimary} onClick={onSignup}>
                  시작하기
                </button>
              </div>
