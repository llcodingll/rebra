        ...
        <div className={styles.leftContent}>
          ...
          <div className={styles.features}>
            <div className={styles.feature}>
              ...
              <div>
                <h3>즉시 시작</h3>
                <p>가입 후 바로 리밸런싱 서비스를 이용할 수 있어요</p>
              </div>
            </div>
            ...
            <div className={styles.feature}>
              <div className={styles.featureIcon}>
                <svg width='14' height='14' viewBox='0 0 14 14' fill='none'>
                  <path
                    d='M12.7173 5.83333C12.9837 7.14076 12.7938 8.5 12.1793 9.68438C11.5649 10.8688 10.5629 11.8067 9.34063 12.3418C8.11833 12.8768 6.74953 12.9767 5.46251 12.6247C4.17548 12.2727 3.04803 11.4901 2.26816 10.4075C1.48829 9.32484 1.10315 8.00756 1.17697 6.67531C1.25079 5.34306 1.7791 4.07639 2.6738 3.08652C3.5685 2.09665 4.77551 1.44342 6.09354 1.23576C7.41157 1.02811 8.76096 1.27859 9.91667 1.94542'
                    stroke='white'
                    strokeWidth='1.16667'
                    strokeLinecap='round'
                    strokeLinejoin='round'
                  />
                  <path
                    d='M5.25 6.41667L7 8.16667L12.8333 2.33333'
                    stroke='white'
                    strokeWidth='1.16667'
                    strokeLinecap='round'
                    strokeLinejoin='round'
