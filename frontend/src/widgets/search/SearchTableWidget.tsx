  ...
  const filteredData = useMemo(() => {
    ...
    return stockListData.filter(stock => {
      if (searchType === 'name') {
        ...
        return stock.code.toLowerCase().includes(searchQuery.toLowerCase());
      }
    });
  }, [searchQuery, searchType]);

  return (
    <div className={styles.searchTableWidget}>
      {/* 검색 컨트롤 */}
      <div className={styles.controlContainer}>
        <div className={styles.searchContainer}>
          <div className={styles.searchTypeButtons}>
            <button
              className={`${styles.typeButton} ${searchType === 'name' ? styles.active : ''}`}
              onClick={() => setSearchType('name')}
            >
              종목명
            </button>
            <button
              className={`${styles.typeButton} ${searchType === 'code' ? styles.active : ''}`}
        ...
        {searchQuery.trim() === '' ? (
          ...
          <>
            ...
            <div className={styles.tableHeader}>
              ...
              <span className={styles.headerCode}>코드</span>
