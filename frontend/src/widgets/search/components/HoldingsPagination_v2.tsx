...
import styles from './HoldingsPagination_v2.module.css';
...
export default function HoldingsPagination_v2({ currentPage, totalPages, onPageChange }: HoldingsPaginationProps) {
