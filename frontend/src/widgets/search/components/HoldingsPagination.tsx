...
import styles from './HoldingsPagination.module.css';
...
export default function HoldingsPagination({ currentPage, totalPages, onPageChange }: HoldingsPaginationProps) {
