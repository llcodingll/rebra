...
export default function WatchlistTableWidget({ onStockSelect }: WatchlistTableWidgetProps) {
  ...
  return (
    <div className={styles.watchlistTableWidget}>
      {/* 관리 컨트롤 */}
      <div className={styles.controlContainer}>
        <div className={styles.controlLeft}>
          ...
          <div className={styles.viewButtons}>
            <button
              className={`${styles.viewButton} ${!showAll ? styles.active : ''}`}
          ...
          <div className={styles.emptyState}>
            <div className={styles.emptyIcon}>
              <svg width="48" height="48" viewBox="0 0 20 20" fill="none">
                <path d="M10 15.27L16.18 19l-1.64-7.03L20 7.24l-7.19-.61L10 0 7.19 6.63 0 7.24l5.46 4.73L3.82 19z" fill="#d1d5db"/>
              </svg>
            </div>
