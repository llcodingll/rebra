        ...
        <div className={styles.tableContent}>
          <div className={`${styles.tableColumn} ${styles.singleColumn}`}>
            ...
            <div className={styles.singleColumnData}>
              <div className={styles.singleDataValue}>{formatNumber(holdingData.buyPrice)}원</div>
            </div>
          </div>
          <div className={styles.tableColumn}>
            ...
            <div className={styles.columnData}>
              <div className={`${styles.dataValue} ${styles.profitValue}`}>+{formatNumber(holdingData.profitLoss)}</div>
              <div className={`${styles.dataValue} ${styles.profitValue}`}>+{holdingData.profitRate}%</div>
            </div>
          </div>
          <div className={styles.tableColumn}>
