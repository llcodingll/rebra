...
public interface StockTradingService {
     ...
     * @return 주문 결과
     */
    StockTradeResponse buyStock(String stockCode, StockTradeRequest request, Long userId);
     ...
     * @return 주문 결과
     */
    StockTradeResponse sellStock(String stockCode, StockTradeRequest request, Long userId);
}