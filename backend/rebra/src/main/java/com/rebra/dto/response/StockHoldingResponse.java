...
public class StockHoldingResponse {
    ...
    public static StockHoldingResponse from(InquireBalanceResult.Output1 holding) {
        ...
        return StockHoldingResponse.builder()
                ...
                .currentPrice((int) Double.parseDouble(holding.getPrpr()))
                .evaluationProfitLoss((int) Double.parseDouble(holding.getEvluPflsAmt()))
                .returnRate(returnRate)
                .priceChange((int) Double.parseDouble(holding.getBfdyCprsIcdc()))
                .changeRate(Double.parseDouble(holding.getFlttRt()))
                .purchaseAmount((int) Double.parseDouble(holding.getPchsAmt()))
                .evaluationAmount((int) Double.parseDouble(holding.getEvluAmt()))
